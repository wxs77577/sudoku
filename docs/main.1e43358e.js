...
},{}],"src/sudoku.js":[function(require,module,exports) {
"use strict";
...
*/
var sudoku = {};
var _default = sudoku; // Global reference to the sudoku library
...
var _default = {
  ...
  methods: {
    getIsDisabled: function getIsDisabled(n) {
      var times = 0;
    ...
    changeLevel: function changeLevel(key) {
      if (window.confirm("确定要重新开始吗？")) {
        this.currentLevel = key;
        this.init(true);
      }
    },
    getClasses: function getClasses(m, n) {
      var i = this.getIndex(m, n);
      var isSameColumn = this.currentIndex % 9 === n - 1;
      var isSameRow = parseInt(this.currentIndex / 9) === m - 1;
      var isSameNumber = this.data[i] && this.data[i] === this.data[this.currentIndex];
      var isBorder = m % 3 === 0 || n % 3 === 0;
      return {
        invalid: this.errors[i],
        active: this.currentIndex === i,
        same: isSameNumber,
        "border-r": n % 3 === 0,
        "border-b": m % 3 === 0 // highlight: isSameColumn || isSameRow,

      };
    },
    getIndex: function getIndex(m, n) {
      return (m - 1) * 9 + n - 1;
    },
    initRaw: function initRaw() {
      this.raw = _sudoku.default.generate(parseInt(this.currentLevel));
    },
    init: function init() {
      ...
      this.ret = _sudoku.default.solve(this.raw);
      this.data = this.raw.split("").map(function (v) {
        return v === "." ? "" : v;
      });
      this.setupTimer();
    },
    input: function input(i, value) {
      if (!value) {
        return;
      }

      var valid = this.check(i, value);
      this.$set(this.errors, i, !valid);
      console.log(i, value, valid);
      this.$set(this.data, i, value);
    },
    check: function check(i, value) {
      var valid = String(this.ret[i]) === String(value);
    ...
    setupTimer: function setupTimer() {
      ...
      timer = setInterval(function () {
        _this.time = (0, _dayjs.default)().subtract(_this.begin).format("mm:ss");
      }, 1000);
    }
  },
  created: function created() {
    ...
    window.onkeypress = function (e) {
      if (e.keyCode >= 48 && e.keyCode <= 57) {
        _this2.input(_this2.currentIndex, e.key);
      }
    };
  }
};
exports.default = _default;
        var $1017b4 = exports.default || module.exports;
      
      if (typeof $1017b4 === 'function') {
        $1017b4 = $1017b4.options;
      }
    
        /* template */
        Object.assign($1017b4, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c("div", { staticClass: "p-3" }, [
    _c(
      ...
      _vm._l(_vm.levels, function(name, key) {
        return _c(
          "div",
          {
            key: key,
            staticClass: "nav-link",
            class: { active: _vm.currentLevel == key },
            on: {
              click: function($event) {
                return _vm.changeLevel(key)
              }
            }
          },
          [_vm._v(_vm._s(name))]
          ...
          return _c(
            ...
            _vm._l(9, function(n) {
              return _c(
                ...
                {
                  key: m + "-" + n,
                  class: _vm.getClasses(m, n),
                  on: {
                    click: function($event) {
                      _vm.currentIndex = _vm.getIndex(m, n)
                    }
                  }
                },
                [_vm._v(_vm._s(_vm.data[_vm.getIndex(m, n)]))]
              )
            }),
            0
          )
      ...
      _vm._l(9, function(n) {
        return _c(
          "button",
          {
            ...
            attrs: { disabled: _vm.getIsDisabled(n), type: "button" },
            on: {
              click: function($event) {
                return _vm.input(_vm.currentIndex, n)
              }
            }
          },
          [_vm._v(_vm._s(n))]
      ...
      _c("div", { staticClass: "col-8" }, [
        _vm.wrongTimes
          ? _c("div", { staticClass: "alert alert-danger text-center" }, [
              _vm._v("哟，错了" + _vm._s(_vm.wrongTimes) + "次咯。")
            ])
          : _vm._e()
      ])
    ]),
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "mt-3 text-center" }, [
      _c("a", { attrs: { href: "https://github.com/wxs77577/sudoku" } }, [
        _vm._v("https://github.com/wxs77577/sudoku")
      ])
    ])
  }
]
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$1017b4', $1017b4);
          } else {
            api.reload('$1017b4', $1017b4);
          }
        }
...
},{"dayjs":"node_modules/dayjs/dayjs.min.js","./sudoku":"src/sudoku.js","_css_loader":"../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"node_modules/bootstrap/dist/css/bootstrap.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
