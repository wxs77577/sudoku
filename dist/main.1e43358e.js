...
var _default = {
  ...
  methods: {
    ...
    onInput: function onInput(x, y, e) {
    ...
    check: function check() {
      ...
      for (var _i = 0; _i < this.len; _i++) {
        ...
        for (var j = 0; j < this.len; j++) {
          row.push(this.data[j][_i]);
        }

        this.isSuccess = this.validate(row);

        if (!this.isSuccess) {
          console.log("\u7B2C".concat(_i + 1, "\u5217\u6709\u8BEF"));
          return false;
        }
      } // check 9-cell
      ...
      if (len === 9) {
        for (var _i2 = 0; _i2 < 3; _i2++) {
          ...
          for (var _j = 0; _j < this.len; _j++) {
            _row.push(this.data[_j][_i2]);
          }

          this.isSuccess = this.validate(_row);

          if (!this.isSuccess) {
            console.log("\u7B2C".concat(_i2 + 1, "\u4E2A\u4E5D\u5BAB\u683C\u6709\u8BEF"));
            return false;
          }
        }
      }
...
exports.default = _default;
        var $41b471 = exports.default || module.exports;
      
      if (typeof $41b471 === 'function') {
        $41b471 = $41b471.options;
      }
    
        /* template */
        Object.assign($41b471, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", [
    _c("h5", [_vm._v(_vm._s(_vm.isSuccess))]),
    _vm._v(" "),
    _c(
      "table",
      [
        _c(
          ...
          [
            _c("td"),
            _vm._v(" "),
            _vm._l(_vm.len, function(m) {
              return _c("td", { key: m }, [_vm._v(_vm._s(m))])
            })
          ],
          2
        ),
        ...
        _vm._l(_vm.len, function(m) {
          return _c(
            ...
            { key: m },
            [
              _c("td", [_vm._v(_vm._s(m))]),
              _vm._v(" "),
              _vm._l(_vm.len, function(n) {
                return _c("td", { key: m + "-" + n }, [
                  _vm.data[m - 1]
                    ? _c("input", {
                        attrs: { type: "text", maxlength: "1" },
                        domProps: { value: _vm.data[m - 1][n - 1] },
                        on: {
                          focus: function($event) {
                            return _vm.onFocus(m - 1, n - 1)
                          },
                          input: function($event) {
                            return _vm.onInput(m - 1, n - 1, arguments[0])
                          }
                        }
                      })
                    : _vm._e()
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$41b471', $41b471);
          } else {
            api.reload('$41b471', $41b471);
          }
        }
